...
const css = {
  code: "img.svelte-1432gyr{border-radius:100px;width:100px;height:100px}.recipeCover.svelte-1432gyr{margin:5% 0;-o-object-fit:cover;object-fit:cover;background-position:center;background-size:cover;border-radius:15px}.recipeCoverContainer.svelte-1432gyr{display:flex;align-items:center;flex-direction:column;padding:1em;height:100%;width:max-width;border-radius:15px 15px 0px 0px;background:linear-gradient(to top, rgb(255, 255, 255) 0%,rgba(255,255,255,0) 100%)}",
  map: null
};
...
<div><div class="${"recipeCover svelte-1432gyr"}" style="${"background-image:url(../" + escape(recipeObject.thumbnailSrc) + ")"}">
		<div class="${"recipeCoverContainer svelte-1432gyr"}"><img alt="${"Image"}"${add_attribute("src", `../${recipeObject.thumbnailSrc}`, 0)} class="${"svelte-1432gyr"}">
